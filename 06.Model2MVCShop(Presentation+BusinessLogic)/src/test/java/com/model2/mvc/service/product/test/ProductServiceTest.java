...
public class ProductServiceTest {
	...
	public void testAddProduct() throws Exception {
		...
		product.setManuDate("20121212");
		product.setPrice(99999);
		product.setFileName("png123.png");
		...
		Assert.assertEquals("20121212", product.getManuDate());
		Assert.assertEquals(30000, product.getPrice());
		Assert.assertEquals("png123.png", product.getFileName());
	}
	...
	//@Test
	 public void testUpdateProduct() throws Exception{
		...
		product.setProdName("testProdCgName");
		product.setProdDetail("testProdDetail");
		product.setManuDate("19191919");
		product.setPrice(99999);
		product.setFileName("png999.png");
		...
		//==> API 확인
		Assert.assertEquals("testProdCgName", product.getProdName());
		Assert.assertEquals("testProdDetail", product.getProdDetail());
		Assert.assertEquals("19191919", product.getManuDate());
		Assert.assertEquals(99999,  product.getPrice());
		Assert.assertEquals("png999.png", product.getFileName());
	 }
